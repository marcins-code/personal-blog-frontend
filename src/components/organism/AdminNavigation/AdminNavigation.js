...
const AdminNavigation = ({ classes, langMenu }) => (
  <StyledNavWrapper id="main-navigation" className="sidebar blue">
    <StyledList>
      <li>
        <Link as={NavLink} to="/admin" exact>
          Artykuły
        </Link>
      </li>
      <li>
      ...
      <li>
        <Link as={NavLink} to="/admin/series">
          Serie
        </Link>
      </li>
    </StyledList>
